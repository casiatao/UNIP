CUDA_VISIBLE_DEVICES=0,1 python -m torch.distributed.launch  --nproc_per_node 2 --master_port 29590 main_pretrain.py \
    ...
    --model unip_vit_tiny_patch16 --last_heads 16  \
    ...
    --intermediate 18 \
    --output_dir=/your_output_dir/mae_large_layer18_distill_unip_tiny_100ep_infmix \
    --log_dir=/your_log_dir/mae_large_layer18_distill_unip_tiny_100ep_infmix