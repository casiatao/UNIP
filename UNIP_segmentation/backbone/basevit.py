...
class Block(nn.Module):
    ...
    def forward(self, x, return_attention=False, return_attn_feat=False):
        ...
        if return_attn_feat:
            if self.gamma_1 is None:
                ...
                return self.drop_path(self.gamma_1 * y)
        if self.gamma_1 is None:
...
class BaseViT(nn.Module):
    ...
    def __init__(self, img_size=[224], patch_size=16, in_chans=3, num_classes=0, embed_dim=768, depth=12,
                 ...
                 init_values=0, use_mean_pooling=False, masked_im_modeling=False, deit3=False):
        super().__init__()
