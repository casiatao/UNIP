...
class Attention(nn.Module):
    def __init__(
        ...
        self.scale = qk_scale or head_dim ** -0.5  # mark  
...
class Block(nn.Module):
    ...
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop=0., attn_drop=0.,
        ...
        if init_values is not None and init_values != "None":
...
class MAE(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=80, embed_dim=768, depth=12,
                 ...
                 out_indices=[3, 5, 7, 11], fpn1_norm='SyncBN', frozen_stages=-1,
                 deit3=False, use_cls_token=True, use_norm=False):
        super().__init__()
        ...
        if use_abs_pos_emb:
            if self.deit3 or not self.use_cls_token:
